(function ($) {
  ...
  $(function () {
    $.vegas('slideshow', { backgrounds: [
      ...
      { src: '/sites/all/modules/custom/bhack_modifications/images/3d-printing.jpg', fade: 1000, delay: 9000 },
      ...
      src: '/sites/all/modules/custom/bhack_modifications/assets/third/vegas/overlays/10.png'
    });
  });
